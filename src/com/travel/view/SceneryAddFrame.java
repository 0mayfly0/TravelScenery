...
public class SceneryAddFrame extends JFrame {

	private JPanel contentPane;

	private static SceneryAddFrame saf = null;
	...
	public static synchronized SceneryAddFrame getInstance() {
		if (saf == null) {
			saf = new SceneryAddFrame();
		}
		return saf;
	}
